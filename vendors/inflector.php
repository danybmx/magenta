...
class Inflector
{
    ...
    *
    * This method converts this is a title of a post to 'this-is-a-title-of-a-post'
    *
    * @access public
    * @static
    * @param    integer    $string string to transform
    * @return string Url representation of given string.
    */
    static function urlize($word)
    {
		$acents = array('á', 'é', 'í', 'ó', 'ú', 'ñ');
		$replacements = array('a', 'e', 'i', 'o', 'u', 'n');
		$word = str_replace($acents, $replacements, $word);
